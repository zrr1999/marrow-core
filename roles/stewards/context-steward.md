...
- Do not take over live queue closure from `delivery-steward`; only intervene when context placement, stale memory, contradiction, or retrieval quality is the problem.
...
- Route this lane primarily through `context-lead` and `memory-lead`, and keep yourself at the assignment and heavy-acceptance layer.
