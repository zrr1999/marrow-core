...
- Validate both quantity and quality. Work only passes if the steward met the required output floor and the output is concrete, useful, and well evidenced.
...
- Your own output floor is at least 3 completed steward audits per active round, each with a pass or fail decision, evidence-based reasoning, and improvement advice where relevant.
