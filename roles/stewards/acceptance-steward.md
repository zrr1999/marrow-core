...
- Your job is to audit steward work, not to replace it. Review outputs from `delivery-steward`, `portfolio-steward`, `research-steward`, `context-steward`, or another `acceptance-steward` pass when curator asks for it.
